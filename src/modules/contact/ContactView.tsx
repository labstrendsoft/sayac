...
import fondo from '@public/contacto/fondoContacto.webp';
...
export const ContactView = () => {
	return (
		...
		>
			...
			/>
			<h2 className="text-4xl lg:text-5xl font-black text-center text-white relative z-10 mt-28 md:mt-40">
				Contacto
			</h2>
			<Container
				id="contacto"
				className="w-full relative z-10 max-w-[1100px] pb-0 px-0"
			>
				<div className=" grid w-full  grid-cols-1 gap-16 pb-20  text-white  lg:grid-cols-2">
					<div className="max-md:px-6">
						<div className="flex flex-col gap-2 border-b border-white/30 pb-6">
							...
							<h3 className="mb-3 text-xl font-semibold text-white">
								¿Tienes dudas sobre nuestros productos o quieres saber más de
								nosotros?
							</h3>
						...
						<div className="grid grid-cols-1 gap-6 border-b border-white/30 py-8 md:grid-cols-2">
							<div className="flex items-center gap-4">
								...
								/>
								<span className="text-sm">+51 907 466 257</span>
							</div>
							<div className="flex items-center gap-4">
								<Image
									src={mail}
									...
									className="w-5 object-cover lg:w-7"
								/>
								<span className="text-sm">ventas@gruposayaq.com</span>
							</div>
					...
					<div className="border border-gray-400 bg-gradient-to-t from-[#232323] to-[#030107] px-6 py-12 rounded-lg lg:px-10">
						<div className="mb-2">
