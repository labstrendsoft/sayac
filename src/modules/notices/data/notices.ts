...
export const notices: Notice[] = [
	{
		...
		description:
			'Grupo Sayak reafirma su compromiso con la calidad y la innovación en el suministro de tuberías de PVC...',
